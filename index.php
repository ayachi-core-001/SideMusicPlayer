...
/*
Plugin Name: 侧栏音乐播放器
Description: 支持多个音乐平台的音乐播放器，使用网上多个开源项目打包而成
Author: 小柠檬猪
Version: 1.0.1
Author URI: https://www.lemonpig.cn/
*/
            ...
            <section class="eaplayer-main">
                ...
                <form method="post" action="options.php" class="sava-setting">
                    ...
                    <div class="eaplayer-copyright">
                        ...
                        <p>该插件由 <a href="https://www.lemonpig.cn/" target="_blank">小柠檬猪</a> 使用互联网上多个开源项目整合制作，只为方便他人使用 WordPress ，并不对歌曲或代码版权负责，请勿使用于商业用途！</p>
                    </div>
                </form>
